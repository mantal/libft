...
/*   Updated: 2013/11/25 14:03:01 by dlancar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	ft_set(int *a, int *b, int a_val, int b_val)
{
	*a = a_val;
	*b = b_val;
}
...
char			*ft_itoa(int n)
{
	...
	{
		f = (float)(n / exp);
		ft_set((int*)res, &n, ((int)f) + '0', n - ((int)f) * exp);
